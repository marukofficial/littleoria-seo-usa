...
export const metadata: Metadata = {
  title: "Minimalist Style | Elevated Minimal Wardrobe",
  description:
...
const BREADCRUMB_JSON_LD = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Minimalist Style", item: "https://seo-usa.littleoria.com/editorial/minimalist-style" },
  ],
};
